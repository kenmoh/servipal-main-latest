...
export const ItemCardSkeleton: React.FC = () => {
    ...
    return (
        <View style={[styles.cardContainer, { backgroundColor: theme.cardBackground.val }]}>
...
export const StatCardSkeleton: React.FC = () => {
    ...
    return (
        <View style={[styles.statCard, { backgroundColor: theme.cardDark.val }]}>
...
export const StoreCardSkeleton: React.FC = () => {
    ...
    return (
        <View style={[styles.storeCard, { backgroundColor: theme.cardBackground.val }]}>
