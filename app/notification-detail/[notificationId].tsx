...
import { ReportResponse, ThreadMessage } from "@/types/review-types";
...
const NotificationDetails = () => {
    ...
    const renderItem = ({ item, index }: any) => {
        ...
        return (
            <XStack alignItems="flex-start" marginBottom={dynamicMargin}>
                    ...
                    {isTyping && (
                        ...
                        >
                            <XStack gap={4} alignItems="center">
                                <Text style={{ color: theme.gray10.val, fontSize: 15 }}>typing</Text>
                                <XStack gap={2}>
                                    <View
                                        style={{
                                            width: 4,
